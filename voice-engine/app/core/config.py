...
class Settings(BaseSettings):
    ...
    barge_in_confirmation_ms: int = Field(default=240, alias="BARGE_IN_CONFIRMATION_MS")
    barge_in_min_confidence: float = Field(default=0.70, alias="BARGE_IN_MIN_CONFIDENCE")
    barge_in_min_rms: float = Field(default=0.030, alias="BARGE_IN_MIN_RMS")
    vocal_energy_ratio_threshold: float = Field(default=0.55, alias="VOCAL_ENERGY_RATIO_THRESHOLD")
